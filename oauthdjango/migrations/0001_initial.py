    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', oauthdjango.fields.JSONField(default=b'{}')),
                ('user', models.ForeignKey(related_name=b'social_auth', to=settings.AUTH_USER_MODEL)),
            ],
            options={
